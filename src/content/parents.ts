...
export const PARENT_ARTICLES: readonly ParentArticle[] = [
  ...
  { id: 'retainers', category: 'Guides', title: { lead: 'A full guide to', rest: 'retainers — why? when? & how?' }, summary: 'The plain-English version of what retainers do and how to make them part of a normal evening.', fill: 'coral', image: { stem: 'retainer-product', alt: 'A clear dental retainer on a white background.', width: 901, height: 305, logoTone: 'cobalt', doodle: 'markZigzag', doodleTone: 'canary' } },
